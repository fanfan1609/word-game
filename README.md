Build an HTML5 interactive dictionary  (let’s call it “app”) that functions as the one shown in the attached video. The app will be the central part of a web page.
